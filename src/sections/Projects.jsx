...
const Projects = () => {
    ...
    const [selectedProject, setSelectedProject] = useState(0); // Initialize state first
    const currentProject = myProjects[selectedProject]; // Then reference the state
    ...
    return (
        <section id='work' className="c-space my-20">
            <p className="head-text ">Explore My Work</p>
  ...
  <span className="animate-ping absolute inline-flex h-full w-full rounded-full "><img
      src="/assets/arrow-up.png" className="w-3 h-3" alt="arrow-up"/></span>
